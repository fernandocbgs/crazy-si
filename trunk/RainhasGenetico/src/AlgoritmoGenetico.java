...
public class AlgoritmoGenetico {
	...
	public void executar() {
		for(int i = 0; i <= totalGeracoes; i++)
		{
			...
			ordenar();
			//resultado
			System.out.println("Gera��o: " + i + " Cromossomo mais apto: " + listaDeCromossomos.get(totalCromossomos-1).getFitness());
			System.out.println("Gera��o: " + i + " Cromossomo menos apto: " + listaDeCromossomos.get(0).getFitness());
