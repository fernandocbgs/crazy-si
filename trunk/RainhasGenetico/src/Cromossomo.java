...
public class Cromossomo implements Comparable<Cromossomo>{
	...
	//numero de colis�es para o cromossomo
	private double numeroDeColisoes = 0;
	
	/**
	 * Um cromossomo representa a posi��o de todas as rainhas no tabuleiro
	...
	/**
	 * Retorna se a rainha est� na mesma linha que a outra
	 * @return
	 */
	...
	/**
	 * Retorna se a rainha est� na mesma diagonal que a outra
	 * @return
	 */
